...
public class Battle extends GameAction {
    ...
    public void performAction(Pokemon p, Inventory inv) {
        ...
        if (Settings.dataVersion.equals("blue")) {
            if (Trainer.getTrainer(0x3A3B5).equals(opponent)) { // brock boulder
                                                                // badge
                p.setAtkBadge(true);
                inv.addItem("TM34");
            } else if (Trainer.getTrainer(0x3A3BB).equals(opponent)) { // misty
                inv.addItem("TM11");
            } else if (Trainer.getTrainer(0x3A3C1).equals(opponent)) { // surge
                                                                       // thunder
                                                                       // badge
                p.setDefBadge(true);
                inv.addItem("TM24");
                ...
                inv.addItem("TM21");
            } else if (Trainer.getTrainer(0x3A3D1).equals(opponent) || Trainer.getTrainer(0x3A3D2).equals(opponent)) { // koga
                                                                                                                       // soul
                                                                                                                       // badge
                p.setSpdBadge(true);
                inv.addItem("TM06");
                ...
                inv.addItem("TM46");
            } else if (Trainer.getTrainer(0x3A3DB).equals(opponent)) { // blaine
                                                                       // volcano
                                                                       // badge
                p.setSpcBadge(true);
                inv.addItem("TM38");
            ...
            if (Trainer.getTrainer(0x3A454).equals(opponent)) { // brock boulder
                                                                // badge
                p.setAtkBadge(true);
                inv.addItem("TM34");
            } else if (Trainer.getTrainer(0x3A45A).equals(opponent)) { // misty
                inv.addItem("TM11");
            } else if (Trainer.getTrainer(0x3A460).equals(opponent)) { // surge
                                                                       // thunder
                                                                       // badge
                p.setDefBadge(true);
                inv.addItem("TM24");
                ...
                inv.addItem("TM21");
            } else if (Trainer.getTrainer(0x3A46C).equals(opponent)) { // koga
                                                                       // soul
                                                                       // badge
                p.setSpdBadge(true);
                inv.addItem("TM06");
                ...
                inv.addItem("TM46");
            } else if (Trainer.getTrainer(0x3A476).equals(opponent)) { // blaine
                                                                       // volcano
                                                                       // badge
                p.setSpcBadge(true);
                inv.addItem("TM38");
    ...
    private void doBattle(Pokemon p) {
        ...
        if (opponent instanceof Pokemon) {
            ...
            if (getVerbose() == BattleOptions.ALL || getVerbose() == BattleOptions.SOME
                    || getVerbose() == BattleOptions.EVERYTHING)
