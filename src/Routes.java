...
//        GameAction.printAllStats, 
    ...
    public static final GameAction[] blueSquirtleRoute = {
        Battle.makeBattle(0x3A1E7), //first rival fight
        new Encounter("RATTATA", 3),
        Battle.makeBattle(0x39DD7), //lvl9 bug
        Battle.makeBattle(0x3A3B5), //brock
        GameAction.getBoulderBadge,
        //4 ppl at route 3
        Battle.makeBattle(0x39DDA),
        Battle.makeBattle(0x39D99),
        Battle.makeBattle(0x39DDF),
        Battle.makeBattle(0x39DE5),
        new Evolve("WARTORTLE"),
        
//        GameAction.printAllStats, 
        Battle.makeBattle(0x3A29C), //mt moon rocket
        Battle.makeBattle(0x39F2A), //mt moon nerd
        new Encounter("GEODUDE",8),
        Battle.makeBattle(0x3A209), //cerulean rival fight (if you are squirtle)
